...
class PyEfiTools:
    ...
    # NOT USED kept b.c. is only 3 lines, works great - but no error checking
    def oldMethod(self):
        self.ser.write(b"A")
    ...
    def redisSerialCollectLoop(self, redisDb, channelKey):
        ...
        ttyP(4, ("  pubSubKey @ %s%s" % (self.endc, channelKey)))
